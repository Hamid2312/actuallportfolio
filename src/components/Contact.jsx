...
const Contact = () => {
  ...
  const contactInfo = [
    {
      ...
      href: "https://www.google.com/maps?q=Chungi+Amar+Sidhu+Lahore"
    },
    {
      type: "Email",
      icon: (
  ...
  const handleSubmit = e => {
    ...
    emailjs.send(
      'service_7jpwnyd', // Replace with your service ID
      'template_nu0j2ai', // Replace with your template ID
      { from_name: name, from_email: email, phone: phone || "N/A", subject: subject || "No Subject", message },
      'RbVUdgkgNSU1oYJ2N' // Your public key
    )
    .then(() => {
